    ...
    if($do == 'manage'){ 
                ...
                $stmt = $con->prepare("SELECT 
                                        ...
                                        INNER JOIN 
                                            users 
                                        ON 
                                            users.userid = items.member_id")  ; //جلب البيانات مع عمل اينر جوين للتيبلات الثانية 
            ...
            ?>
                ...
                <h1 class="text-center"><?php echo lang('mange-items') ; ?></h1> 
                <div class="container">
                    <div class="tabel-responsive">
                        <table class="main-table text-center table table-bordered">
                            ...
                            foreach($items as $item) {
                                ...
                                <a href='items.php?do=delete&itemid=" .$item['item_id'] . "'class='btn btn-danger confirm'>del</a>"; 
...
<h1 class="text-center"><?php echo lang('edit-item') ; ?></h1> 
                <div class="container okmmm">
