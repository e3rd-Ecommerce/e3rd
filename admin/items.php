            ...
            ?>
                        ...
                        <thead>
                            ...
                            foreach($items as $item) {
                                ...
                                echo "<tr>" ; 
                                echo "<td>" . $count++. "</td>" ;
                                //echo '<td><img src="../imageAdmin/'.$item['image'].'" alt="Not Found" </td>';
                                echo "<td><img src='../imageAdmin/".$item['image']."' alt='Not Found'></td>";
...
<?php
                ...
                <h1 class=""><?php echo lang('add-new-item') ; ?></h1> <hr>
                    ...
                    <div class=" row mb-3  ">
                            <label class="col-sm-2 col-md-2 col-lg-2 col-form-label">Image Files :</label>
    ...
    <?php 
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if ( !is_dir("../imageItems/$name$member")) {
                mkdir("../imageItems/$name$member"); 
                $targetDir = "../imageItems/$name$member/"; 
            ...
            if(empty($formErros)){
                        ...
                        $stmt = $con->prepare("INSERT INTO 
                                        items(name,description,price,country_made,status ,cat_id ,member_id,add_date,images)
                                        VALUE(:zname , :zdesc , :price  ,:country , :zstatus, :zcat , :zmember, now(),:images )
                                        ") ; 
                        $stmt->execute(array(
                            'zname'   => $name ,
                            'zdesc'   => $desc , 
